...
public class JogoAdivinheAsFrutas implements MecanicaDoJogo {

	private String palavraArquivo;
	private	int ponto = 0;
	private	final int chancesPalavra = 1, quantidadePavalavras = 10;
	...
	public void regrasBasicas() {
		...
		System.out.println("=           Adivinhe os nomes de comidas           =");
		System.out.println("====================================================");
		...
		System.out.println("=     corresponde a comida apresentada             =");
		System.out.println("=  2. Serão apresentadas 10 tipos de comidas       =");
		System.out.println("=     diferentes                                   =");
		System.out.println("=  3. Para ganhar você deve acertar 5 delas        =");
