...
public class JogoAdivinhePalavrasAleatorias implements MecanicaDoJogo{
	private String palavraArquivo;
	private	int ponto = 0;
	private	final int chancesPalavra = 1, quantidadePavalavras = 50;
	...
	private String pegarPalavra() {
		palavraArquivo = bancoPalavras.pegaPalavra("/D:/Users/Dell/eclipse-workspace/JogoDePalavras/arquivo04.txt");
	...
	public void regrasBasicas() {
		...
		System.out.println("=           Adivinhe as palavras aleatórias        =");
		System.out.println("====================================================");
		...
		System.out.println("=     corresponde a elas                           =");
		System.out.println("=  2. Serão apresentadas 50 tipos de palavras      =");
		System.out.println("=     aleatórias                                   =");
		System.out.println("=  3. Para ganhar você deve acertar 25 delas       =");
		System.out.println("=  4. Caso erre, você terá uma tentativa por       =");
