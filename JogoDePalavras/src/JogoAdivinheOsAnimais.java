...
public class JogoAdivinheOsAnimais implements MecanicaDoJogo{
	private String palavraArquivo;
	private	int ponto = 0;
	private	final int chancesPalavra = 2, quantidadePavalavras = 20;
	...
	public void regrasBasicas() {
		...
		System.out.println("=           Adivinhe os nomes dos animais          =");
		System.out.println("====================================================");
		...
		System.out.println("=     corresponde ao animais apresentados          =");
		System.out.println("=  2. Serão apresentadas 20 tipos de animais       =");
		System.out.println("=     diferentes                                   =");
		System.out.println("=  3. Para ganhar você deve acertar 10 delas       =");
